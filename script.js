// Posición fixed aparente
document.addEventListener("DOMContentLoaded", function () {
  const navbar = document.getElementById("navbar");
  const toggleFixedBtn = document.getElementById("toggleFixed");
  const banner = document.getElementById("banner-presentacion-sin-fixed");

  toggleFixedBtn.addEventListener("click", function () {
    // Quitar el fixed del navbar al abrir el modal
    navbar.classList.add("change-static");
    banner.classList.add("banner-presentacion-cont-sin-fixed");
  });

  // Escucha el evento de cierre del modal
  modal.addEventListener("click", function () {
    // Revertir el estado del navbar al cerrar el modal
    navbar.classList.remove("change-static");
    banner.classList.remove("banner-presentacion-cont-sin-fixed");
  });
});
